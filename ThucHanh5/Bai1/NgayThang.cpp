...
bool NgayThang::KiemTraHopLe() const {
    ...
    if (thang == 4 || thang == 6 || thang == 9 || thang == 11) {
        ...
        // Cong thuc tinh nam nhuan: Chia het cho 400 HOAC (chia het cho 4 nhung khong chia het cho 100)
...
void NgayThang::Nhap() {
    ...
    cout << "Nhap ngay, thang, nam sinh (cach nhau boi khoang trang): ";
    if (!(cin >> ngay)) {
        isError = true;
        cin.clear();
        string rac;
...
bool NgayThang::LonTuoiHon(const NgayThang& khac) const {
